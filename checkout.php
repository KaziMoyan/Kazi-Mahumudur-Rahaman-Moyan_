...
<div class="heading">
   <h3>checkout</h3>
   <p><a href="home.php">home</a> <span> /Service checkout</span></p>
</div>

<section class="checkout">

   <h1 class="title">Services summary</h1>
...
<form action="" method="post">
   ...
   <div class="user-info">
      ...
      <select name="method" class="box" required>
         ...
         <option value="cash on delivery">Right Now Payment</option>
